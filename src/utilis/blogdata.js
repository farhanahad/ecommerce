const blogList = [
  {
    id: 1,
    imgUrl:
      "https://i.ibb.co/Xkk5fc0/empowering-breast-cancer-care-leveraging-medical-equipment-financing.jpg",
    imgAlt: "Blog Thumb",
    title:
      "Empowering Breast Cancer Care: Leveraging Medical Equipment Financing",
    desc: "In breast cancer care, staying at the forefront of diagnostics and treatment is crucial. However, acquiring state-of-the-art ",
    commentCount: "3",
    btnText: "Read More",
    metaList: [
      {
